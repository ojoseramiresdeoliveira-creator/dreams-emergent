...
// Stones settle with mass — one small overshoot, then rest.
// HEAVY is the ceremonial variant for a freshly inscribed stone.
export const SPRING_STONE = { type: 'spring', stiffness: 200, damping: 21, mass: 1.15 };
export const SPRING_STONE_HEAVY = { type: 'spring', stiffness: 150, damping: 17, mass: 1.5 };
